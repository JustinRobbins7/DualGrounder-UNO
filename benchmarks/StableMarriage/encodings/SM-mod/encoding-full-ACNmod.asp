...
% Changed from :- manAssignsScore(M,_,_), not jailed(M).
% DualGrounder is currently unable to encode constraints with dropped arguments.
:- manAssignsScore(M,N,P), not jailed(M).
